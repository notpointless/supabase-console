...
Deno.serve(async (req: Request) => {
  ...
  // them to .secrets.json in this volume; we read per-request so updates apply live
  // without restarting the container. Defensive: a missing/invalid file is ignored.
  let userSecrets = {}
  try {
