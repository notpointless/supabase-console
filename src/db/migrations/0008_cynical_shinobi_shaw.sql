CREATE TABLE "org_oauth_app" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"organization_id" text NOT NULL,
	"client_id" text NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "org_oauth_app_client_id_unique" UNIQUE("client_id")
);
...
--> statement-breakpoint
ALTER TABLE "org_oauth_app" ADD CONSTRAINT "org_oauth_app_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
